      ...
      <section className="main-container">
        ...
        <div className="main-container__content">
          ...
          <Chat
            ...
            text1={(
              <p>
                Bienvenido a la línea de mayor feliz. Primero mira el video completo.
                <br />
                <br />
                Una vez termines el video, para hacer parte de esta experiencia de dos semanas, revisa las
                condiciones de la actividad, y si estas de acuerdo haz clic en el botón de “acepto el reto”.
                {' '}
                <br />
                <br />
              </p>
